...
empresa.method = {
    ...
    adicionarHorario: () => {
        ...
        // primeiro valida se tem alguma linha sem registro
    ...
    // valida dos campos e salva os horarios
    salvarHorario: () => {
                      ...
                      <select class="form-control" id="diainicio-\${id}">
                                ...
                                <div class="col-7">
                                    <div class="row">
                                        ...
                                        <div class="col-3">
                                            <div class="form-group">
                                             <p class="title-categoria mb-0"><b>dás *:</b></p>
                                        ...
                                        <div class="col-3">
                                            <div class="form-group">
                                             <p class="title-categoria mb-0"><b>e dás:</b></p>
