...
pedido.method = {
    ...
    // obtem o ultimo pedido realizado
    obterUltimoPedido: () => {
    ...
    carregarEtapas: (data) => {
        ...
        if (data.idpedidostatus == 1) {
            ...
            pedidoEnviado = pedidoEnviado.replace(/\${status}/g, 'active')
              ...
              .replace(/\${descricao}/g, 'Aguardando a confirmação do estabelecimento.')
    ...
    mensagemWhatsaApp: () => {
        ...
        var texto = 'Olá! gostaria de sabe sobre o meu pedido: Nº ' + idpedido;

        // cria a URL
        let encode = encodeURI(texto);
        let URL = `https://wa.me/5591981334571?text=${encode}`;
...
pedido.template = {
    ...
    dadospedido: `
     <div class="card card-status-pedido mb-4">
        ...
        <div class="detalhes-produto-acoes" onclick="pedido.method.mensagemWhatsaApp()">
