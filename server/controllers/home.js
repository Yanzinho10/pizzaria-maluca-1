...
const controllers = () => {
    ...
    const obterTotaisFormaPagamento = async (req) => {
        ...
        try {
            ...
            var ComandoSql = await readCommandSql.retornaStringSql('obterTotaisFormaPagamento', 'home');
    ...
    const obterTotaisTiposEntrega = async (req) => {
        ...
        try {
            ...
            var ComandoSql = await readCommandSql.retornaStringSql('obterTotaisTiposEntrega', 'home');
            var result = await db.Query(ComandoSql);
    ...
    const obterTotaisPedidoHoje = async (req) => {
        ...
        try {
            ...
            var ComandoSql = await readCommandSql.retornaStringSql('obterTotaisPedidoHoje', 'home');
            var result = await db.Query(ComandoSql, {
    ...
    const obterTotaisDiasSemana = async (req) => {
        ...
        try {
            ...
            var ComandoSql = await readCommandSql.retornaStringSql('obterTotaisDiasSemana', 'home');
            var result = await db.Query(ComandoSql);
