...
const controllers = () => {
    ...
    const salvarOpcionaisProduto = async (req) => {
        ...
        try {
            ...
            // valida se e um opcional simples ou seleção de opções
            if (req.body.simples) {

                // OPCIONAL SIMPLES

                // valida se o opcional simples ja existe no produto
                ...
                if (result === undefined || result.length === 0) {
                    ...
                    // ja existe um opcional cadastrado, adiciona um novo
