...
const controllers = () => {
    ...
    const removerProduto = async (req) => {
        ...
        try {
            ...
            var idproduto = req.body.idproduto;
                ...
                // cria um objeto da mesma estrutura que o metodo de removerImagemProduto espera.
                const requisicao = {
                    body: {
                        idproduto: idproduto,
                        apagado: 0
                ...
                if ( imagemRemovida.status == "success") {
                 ...
                 return {
                    ...
                    return {
                        status: 'error',
                        message: 'Falha ao remover o Produto. Tente novamente.'
                    }
    ...
    const duplicarProduto = async (req) => {
        ...
        try {
            ...
            // altera o nome do produto copiado para "Copia" é o nome da imagem para ID criado
